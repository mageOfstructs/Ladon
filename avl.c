...
// void remove(tree_node_t *prev, tree_node_t *node_to_remove) {
//   if (prev->left == node_to_remove) {
//     prev->left = node_to_remove->left;
//     append_ordered(prev->left, node_to_remove->right,
//                    cmp); // TODO: need a global context for this
//   }
// }
...
void test_avl() {
  tree_node_t root = TREE_NODE_INIT, l1 = TREE_NODE_INIT, l2 = TREE_NODE_INIT,
